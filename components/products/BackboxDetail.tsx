            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><b>Type:</b> {product.specifications.type}</li>
                  <li><b>Depth:</b> {product.specifications.depth}</li>
                  <li><b>Material:</b> {product.specifications.material}</li>
                  <li><b>Mounting:</b> {product.specifications.mounting}</li>
