            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm">
                  <div className="text-2xl font-bold text-blue-600 mb-1">{product.specifications.model || 'N/A'}</div>
                  <div className="text-sm text-gray-500">Model</div>
                </div>
                <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm">
                  <div className="text-2xl font-bold text-green-600 mb-1">{product.specifications.connectorType}</div>
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-2xl border border-gray-100">
                          ...
                          <div className="space-y-4">
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                              ...
                              <span className="text-gray-900 font-bold">{product.specifications.model || 'N/A'}</span>
                            </div>
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                              <span className="text-gray-600 font-medium">Connector Type</span>
                              <span className="text-gray-900 text-sm ml-8 font-bold">{product.specifications.connectorType}</span>
                            </div>
                            <div className="flex justify-between items-center py-3">
                              <span className="text-gray-600 font-medium">Category</span>
                              <span className="text-gray-900 font-bold">{product.specifications.category}</span>
                            </div>
                          </div>
                        </div>
                      </div>
